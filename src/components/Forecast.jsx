	...
	function ForecastCard() {
		return (
			<div className='flex col-start-4 row-start-10 row-span-3 col-span-9 cursor-default ml-2 pb-4'>
				{days.map((day, i) => (
					<>
						<div className='flex flex-1 flex-col justify-around text-white p-2 ml-1 mr-1 border-b-1 rounded-3xl shadow-2xl backdrop-blur-xs duration-300 ease-in-out hover:scale-105'>
							<div>
